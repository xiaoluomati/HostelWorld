 ...
 */
public class ListMemberStatisticsHandler extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException {
        ...
        out.println("<div class=\"alert alert-info\" role=\"alert\">\n" +
                "您有<strong>" + (numberOfOrdered + numberOfCanceled + numberOfCompleted) + "</strong>条预订记录,\n" +
        ...
        out.println("</tbody>\n" +
                "    </table>");
        out.println("<div class=\"alert alert-info\" role=\"alert\">\n" +
                "您有<strong>" + (numberOfCash + numberOfNotCash) + "</strong>条入住记录,\n" +
